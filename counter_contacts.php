...
<!-- Mirrored from trendingtemplates.com/demos/trips/shortcodes-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Apr 2016 19:24:53 GMT -->
<head>
...
$sql = "SELECT *FROM bus order by counter_name";
    ...
    $x = 1; 
     ...
     // echo '<a href="display.php?name='. $id.'">link1</a>';
        ...
        echo    '<div class="col-sm-10">
                            <ol class="c2">
                                <li><h6 class="sansserif"><span>'.$x.'</span>' . $row["counter_name"]. ' : ' . $row["counter_address"]. '  ( ' . $row["counter_contact"]. ' )</h6></li>
