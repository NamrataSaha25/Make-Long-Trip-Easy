...
$sql = "SELECT *FROM bus where source ='$src' and bus_name='$busname' and destination= '$des' ";
...
<th><strong>Journey Duration</strong></th>
     ...
     while($row = $result->fetch_assoc()) {
         ...
         <td>" . $row["destination"] ."</td>
          <td>" . $row["bus_name"]. "  " . $row["last_name"]. " </td>
         <td>" . $row["counter_name"]. "
  
        <ul>

        <li>" . $row["counter_address"]. "</li>
        <li>" . $row["counter_contact"]. "</li>
