...
$sql = "SELECT distinct bus_name FROM bus where source= '$src' and destination='$des'";
        ...
        echo    '<div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="pricing-table">
                                ...
                                <div class="pricing-table-footer">
                                   ...
                                   <h3><a href="counters.php?busname='.$bus.'&source='.$src.'&destination='.$des.'" target="_blank">See More</a><h3>
                                </div><!-- end footer -->
